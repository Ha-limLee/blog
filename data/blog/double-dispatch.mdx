...
1. Double dispatch란?
2. [Visitor pattern을 이용한 Double dispatch](double-dispatch-using-visitor-pattern)
3. [Dispatch table을 이용한 Double dispatch](double-dispatch-using-dispatch-table)
