...
export const IMAGE_PATH = '/static/images/enhance-build-performance';
...
<ImageFromStatic name="Untitled" />

**.cache 없을 때 빌드 결과**

<ImageFromStatic name="Untitled%201" />

**6분 38.48초** 걸렸다

**.cache 있을 때 빌드 결과**

<ImageFromStatic name="Untitled%202" />
...
<ImageFromStatic name="Untitled%203" />

**4분 29.71초** 걸렸다

**.cache 있을 때 빌드 결과**

<ImageFromStatic name="Untitled%204" />
