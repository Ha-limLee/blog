...
export const IMAGE_PATH = '/static/images/yarn-workspace'
...
<ImageFromStatic name="gitignore-before" />

**node_modules 제외할 때**

<ImageFromStatic name="gitignore-after" />
...
<ImageFromStatic name="yarn-inst-after" />
...
<ImageFromStatic name="front-node_modules" />

**root**

root의 node_modules에는 hoisting 된 패키지들이 있다

<ImageFromStatic name="root-node_modules" />

여기에는 components workspace도 있다

<ImageFromStatic name="root-node_modules-components" />
...
<ImageFromStatic name="react-start-error" />
...
<ImageFromStatic name="react-start-error;unexpected-token" />
...
<ImageFromStatic name="craco-start" />

이제 오류가 발생하지 않는다

그런데 CSS가 제대로 적용되지 않았다

react app에서는 Tailwind CSS를 사용하고 있기 때문에 Tailwind 설정에 components를 추가해줘야 한다
...
<ImageFromStatic name="craco-tailwind" />
