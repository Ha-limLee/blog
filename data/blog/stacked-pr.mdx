...
![big diff](/public/static/images/stacked-pr/big-diff.png)
...
- PR 1: layout 구현
  ...
  ![small diff](/public/static/images/stacked-pr/small-diff.png)
...
- reviewer가 PR 1에 review를 남겼고 author는 그 review를 반영했다.
  ...
  ![update-refs-before](/public/static/images/stacked-pr/update-refs-before.svg)
...
2. review를 반영한 branch를 여기에 rebase 한다. 이때 `--update-refs` 옵션을 준다.
   ...
   ![update-refs-after](/public/static/images/stacked-pr/update-refs-after.svg)
...
- remote
  ...
  ![diverged-remote](/public/static/images/stacked-pr/diverged-remote.svg)

- local

  ![diverged-local](/public/static/images/stacked-pr/diverged-local.svg)
